    ...
    module ConnectionAdapters
      module Sqlite3Adapter
        ...
        def self.included(base)
          ...
          SchemaMonkey.include_once ::ActiveRecord::ConnectionAdapters::SchemaStatements, SchemaMonkey::Core::ActiveRecord::ConnectionAdapters::SchemaStatements::Column
          ...
          SchemaMonkey.include_once ::ActiveRecord::ConnectionAdapters::SchemaStatements, SchemaMonkey::Core::ActiveRecord::ConnectionAdapters::SchemaStatements::Index
        end
